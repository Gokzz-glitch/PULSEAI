...
Generated UTC: 2026-03-29T09:26:12.879691+00:00

## Pass/Fail Matrix

| ID | Criterion | Target | Measured | Status | Evidence |
| --- | --- | --- | --- | --- | --- |
| C1 | Arrhythmia Sensitivity | >= 90% | 46.9% | FAIL | test_results\global_benchmark_report.json |
| C2 | Arrhythmia Specificity | >= 90% | 70.8% | FAIL | test_results\global_benchmark_report.json |
| C3 | 10-Case Real-Time Accuracy | >= 90% | 80.0% | FAIL | test_results\test_10cases_20260329_145545.json |
...
- C3 10-Case Real-Time Accuracy: Increase PVC/other-arrhythmia representation and retain safety-floor escalation for severe rhythms.
